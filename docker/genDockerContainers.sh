...
docker stop CFB2Bn1 CFCOREn1 CFBROKERn1 CFproxyArtemis
docker rm CFB2Bn1 CFCOREn1 CFBROKERn1 CFproxyArtemis
...
docker build --no-cache -f dockerfile-ARTEMIS . -t activemq-artemis-broker-master2.26:1.0
